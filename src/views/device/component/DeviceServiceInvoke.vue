...
<script>
import { productPropsApi, propsTemplateApi } from '../../../api/product'
import { serviceInvokeApi , serviceInvokeReplyApi} from '../../../api/device'
...
export default {
  ...
  methods: {
    sendMsg() {
      ...
      serviceInvokeReplyApi(param).then((data) => {
        this.runResult = JSON.stringify(data, null, 2)
        this.$alert('messageId:' + data.data.messageId + ' 设备响应:' + data.data.msg, 'deivice:'+this.deviceCode, {
